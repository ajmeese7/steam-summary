...
<html lang="en">
  ...
  <body>
    ...
    <div style="height: 40px; text-align: center;">
      <input id="input" type="text" onkeyup="validateInput()" placeholder="ex. 'ajmeese7'">
    </div>

    <section id="steam">
      <!-- TODO: Remove PHP and replace with AJAX / initialize Apache
      server for local, non-production testing -->
